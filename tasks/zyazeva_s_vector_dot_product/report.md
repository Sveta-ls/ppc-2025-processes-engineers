...
| Версия выполнения | Время (микросекунд) | Количество процессов|
|:-----------------|-------------:|-----------------:|
| SEQ | 602 microseconds | 1 |
| MPI | 365.294 microseconds | 4 | 

**Вывод:** при увеличении размерности векторов MPI-версия показывает ускорение примерно в *1.6–1.9 раза*

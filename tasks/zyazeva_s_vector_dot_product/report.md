...
**Вывод:** Из-за накладных расходов на работу с процессами и рассылку данных MPI версия работает 4.5-5 раз медленнее, чем SEQ, поэтому менее эффективна.

---

## 7. Conclusions
1. Созданы две реализации алгоритма: последовательная и с использованием MPI.
2. Обе версии протестированы на векторах большого размера, была исследована эффективность каждого подхода.
3. Даже при больших объёмах данных затраты на использование MPI становятся выше, чем преимущества от распараллеливания.
4. Параллельные вычисления неэффективны для данной задачи.

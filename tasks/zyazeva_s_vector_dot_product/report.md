...
|:-----------------|-------------:|-----------------:|
| SEQ pipeline | 0.0776 | 1 |
| MPI pipeline | 0.0057 | 4 | 
| SEQ task_run | 0.0137 | 1 | 
| MPI task_run | 0.0788 | 4 | 

MPI медленнее SEQ и в task_run и в pipeline.
**Вывод:** Из-за накладных расходов на работу с процессами и рассылку данных MPI версия работает намного медленнее, чем SEQ, поэтому менеее эффективна.

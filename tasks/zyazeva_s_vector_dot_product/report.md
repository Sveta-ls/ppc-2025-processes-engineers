...
| Версия выполнения | Время (секунд) | Количество процессов|
|:-----------------|-------------:|-----------------:|
| SEQ pipeline | 0.0166 | 1 |
| MPI pipeline | 0.0057 | 4 | 
| SEQ task_run | 0.0137 | 1 | 
| MPI task_run | 0.0042 | 4 | 

MPI быстрее SEQ и в task_run и в pipeline.
**Вывод:** при увеличении размерности векторов MPI-версия показывает ускорение примерно в *2.3–3.2 раза*
